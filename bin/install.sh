...
system_76_drivers() {
	...
	apt update
	apt install --reinstall alsa-base alsa-utils pulseaudio linux-sound-base libasound2 -y
	apt install --reinstall system76-driver -y
}
...
install_wmapps() {
	local pkgs="xinit feh i3 i3lock i3status scrot neovim rofi"
